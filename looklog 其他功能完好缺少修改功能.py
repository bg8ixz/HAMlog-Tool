...
import os, re, sqlite3, logging ,csv
from datetime import datetime, timedelta
from PyQt5 import QtCore, QtGui, QtWidgets
from PyQt5.QtWidgets import QMainWindow, QLineEdit, QWidget, QRadioButton, QTableView, QHeaderView, QStyledItemDelegate, QMessageBox, QInputDialog, QFileDialog
from PyQt5.QtCore import Qt, QTimer,  QDate, QTime, QDateTime, QLocale, QRegExp, QAbstractTableModel, QModelIndex
from PyQt5.QtGui import QStandardItemModel, QStandardItem, QValidator, QIcon
...
class LooklogWindow(QMainWindow):
    ...
    def on_tolog_pushButton_clicked(self):
        ...
        default_filename = f"{current_time} 导出的通联日志.csv"
        ...
        if save_path:
            if save_path.endswith('.csv'):
                ...
                QMessageBox.warning(self, "警告", "请选择.csv文件进行保存！")
        else:
